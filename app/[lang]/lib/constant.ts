...
import { TBannerType } from './definitions';
...
export const FOOTER_LINK = [
  { name: 'menu_nav.home', path: ROUTE_PATH.HOME },
  { name: 'menu_nav.shop', path: ROUTE_PATH.SHOP },
  { name: 'menu_nav.freePattern', path: ROUTE_PATH.FREEPATTERNS },
  { name: 'menu_nav.blog', path: ROUTE_PATH.BLOG },
  { name: 'menu_nav.about', path: ROUTE_PATH.ABOUT },
  { name: 'menu_nav.contact', path: ROUTE_PATH.CONTACT },
];
