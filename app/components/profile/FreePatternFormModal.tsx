...
import {
  createUpdateFreePattern,
  fetchFreePatternDetail,
} from '@/app/lib/service/freePatternService'
...
const FreePatternFormModal = ({ modalData, setModalData, onRefreshData }: FreePatternFormProps) => {
  ...
  useEffect(() => {
    if (modalData.id && modalData.open) {
      ...
      fetchFreePatternDetail(modalData.id)
        .then((pattern) => {
          const newPattern = {
            ...pattern,
          ...
          >
            ...
            <Row gutter={48}>
              <Col md={12} xs={24}>
                ...
                >
                  <TreeSelect treeData={categories as DefaultOptionType[]} />
                </Item>
              </Col>
            </Row>
            <Row gutter={48}>
              <Col xs={24} lg={12}>
                <Item name="status" label={t('Fields.status')}>
                  <FreePatternStatus
            ...
            <Item name="description" label={t('Fields.description')}>
              <TextArea rows={4} placeholder={t('Fields.description')} />
            </Item>
            <Item name="files" label={t('Fields.files')}>
              <UploadFiles
            ...
            <Item name="content" label={t('Fields.content')}>
              <CustomEditor
