...
import {
    ...
    deleteComment,
    fetchCommentReplies,
} from '../../lib/service/commentService'
            ...
            <div className="comment-content" style={{ display: 'flex' }}>
                ...
                <div style={{ marginLeft: 12, flex: 1 }}>
                            ...
                            >
                                ...
                                {comment.mentionedUsername && comment.mentionedUserId && (
                                    <Typography.Text
                                        ...
                                        onClick={() =>
                                            navigateToUserProfile(comment.mentionedUserId || '')
                                        }
                                    >
                    ...
                    {comment.replyCount > 0 && !showReplies && (
                        ...
                        >
                            Xem {comment.replyCount}{' '}
                            {comment.replyCount === 1 ? 'câu trả lời' : 'câu trả lời'}
                        </Button>
                    )}
                                    ...
                                    onCommentUpdate={(isDelete = false) => {
                                        if (isDelete) {
                                            ...
                                            setReplies((prevReplies) =>
                                                prevReplies.filter((r) => r.id !== reply.id),
                                            )
                                        } else {
