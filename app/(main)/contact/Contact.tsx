...
import { REGEX, ROUTE_PATH, SOCIALS } from "@/app/lib/constant";
...
const Contact = () => {
  ...
  const contactSchema = createContactPageSchema({
    ...
    phone: "0969545937",
    email: "thamphuong.crochet@gmail.com",
  });
      ...
      <Space direction="vertical" size={40} style={{ width: "100%" }}>
        <Row gutter={30} className="contact-page scroll-animate">
          <Col xs={24} md={12} className="animation-wrap">
            <h1 className="content-title">{t("title")}</h1>
            <p className="content-text">{t("description")}</p>
          </Col>
          <Col xs={24} md={12}>
            <h2 className="align-center">{t("Form.title")}</h2>
            <Form
        ...
        <Divider>
          <h1 className="align-center">{t("Form.via")}</h1>
        </Divider>
        <Row
