...
import { createUpdatePost, fetchPostDetail } from '@/app/lib/service/postService'
                ...
                <Spin spinning={state.loading} tip="Loading...">
                    ...
                    >
                        <Row>
                            ...
                            <Col xs={24} md={12}>
                                <Item name="is_home" label="Show on home">
                                    <Switch />
                                </Item>
                            </Col>
                        </Row>
                        ...
                        <Item name="content" label="Pattern text">
                            <CustomEditor
